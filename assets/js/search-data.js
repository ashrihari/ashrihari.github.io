...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/https:/github.com/ashrihari";
          },
        },{id: "nav-cv",
          title: "cv",
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/https:/drive.google.com/file/d/1WIJ--R4pCDrjU0y0GUsI769dkQ5X_aSx/view?usp=sharing";
          },
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "projects-wheeled-bipedal-robot-pineapple",
          title: 'Wheeled Bipedal Robot - Pineapple',
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%61%73%68%72%69%68%61%32@%61%6E%64%72%65%77.%63%6D%75.%65%64%75", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/ashrihari", "_blank");
        },
      },{
      id: 'light-theme',
